...
export function Spotlight({
  ...
  useEffect(() => {
    ...
    // Named handlers: the original passed fresh arrow functions to both add
    // and remove, so removeEventListener never matched and the listeners
    // leaked on every unmount.
