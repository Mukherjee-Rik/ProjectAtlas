...
export class HealthController {
  ...
  @Get('live')
  @ApiOperation({ summary: 'Liveness probe to check if application process is running' })
  getLiveness() {
    return this.healthService.getLiveness();
  }

  @Get('ready')
  @ApiOperation({ summary: 'Readiness probe validating DB, Queue, and memory health' })
  ...
  @Get('database')
  @ApiOperation({ summary: 'PostgreSQL database connectivity and latency health' })
