...
export class UpdateMenuItemDto {
  ...
  @ApiPropertyOptional() @IsOptional() @IsString() @MinLength(2) @MaxLength(50) @Matches(/^[A-Za-z0-9-]+$/, { message: 'Code can only contain alphanumeric characters and hyphens' }) code?: string;
  ...
  @ApiPropertyOptional() @IsOptional() @IsInt() @Min(0) @Max(1440) preparationTimeMinutes?: number;
