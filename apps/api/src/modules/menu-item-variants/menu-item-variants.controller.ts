...
export class MenuItemVariantsController {
  ...
  @Post('menu-items/:itemId/variant-groups')
  @Permissions(PERMISSIONS.MENU_ITEM_VARIANTS_CREATE)
  async createGroup(
  ...
  @Get('menu-items/:itemId/variant-groups')
  ...
  @Permissions(PERMISSIONS.MENU_ITEM_VARIANTS_UPDATE)
  async updateGroup(
  ...
  @Permissions(PERMISSIONS.MENU_ITEM_VARIANTS_DELETE)
  async removeGroup(
    @Param('id', new ParseUUIDPipe()) id: string,
    @CurrentRestaurant() r: CurrentRestaurantType,
  ) {
  ...
  @Post('variant-groups/:groupId/variants')
  @Permissions(PERMISSIONS.MENU_ITEM_VARIANTS_CREATE)
  async createVariant(
